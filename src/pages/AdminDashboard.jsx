    ...
    <AdminLayout>
      ...
      <div className="page-heading">
        ...
        <div>
          ...
          <p>
            Revenue, repairs and customer activity.
          </p>
        </div>

        <button
          className="btn btn-primary"
          onClick={() => navigate("/admin/new-repair")}
        >
          <Plus size={17} />
          New Repair
        </button>
                ...
                <tr key={repair.id}>
                  ...
                  <td>
                    {repair.finalRepairCost != null
                      ? `₹${Number(repair.finalRepairCost).toLocaleString("en-IN")}`
                      : "Pending"}
                  </td>
                  ...
                  <td>
                    ...
                    <button
                      className="btn-small"
                      onClick={() =>
                        navigate(`/admin/repair/${repair.id}`)
                      }
                    >
                      Manage
                    </button>
...
function PipelineRow({ icon, name, value, type }) {
  return (
    <div className="pipeline-row">
      ...
      <div>
        <span className={`pipeline-icon ${type}`}>
          {icon}
        </span>
